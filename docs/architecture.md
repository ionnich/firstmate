...
A dormant mate (`state/<id>.dormant`, owned by [`bin/fm-secondmate-dormancy.sh`](../bin/fm-secondmate-dormancy.sh)'s header) is deliberately stopped and is skipped rather than relaunched.
