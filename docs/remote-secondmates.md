...
A dormant mate is skipped instead, because its stop is deliberate; the dormancy marker that gates this sweep is owned by [`bin/fm-secondmate-dormancy-lib.sh`](../bin/fm-secondmate-dormancy-lib.sh).
