...
# data/captain.md, data/captain-shared.md, data/captain-opinions.md,
...
#                       data/captain-shared.md, data/captain-opinions.md,
#                       data/learnings.md: read-only,
...
print_file_or_absent "$DATA/captain-opinions.md" "data/captain-opinions.md (advisory, main-authoritative, read-only in secondmate homes)"
